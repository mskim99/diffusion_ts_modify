...
if __name__ == '__main__':
    ...
    fake_data = np.load(
        '/data/jionkim/diffusion_TS/OUTPUT/test_textum/ddpm_fake_test_textum.npy')
    ori_data = np.load(
        '/data/jionkim/diffusion_TS/OUTPUT/test_textum/samples/textum_norm_truth_24_train.npy')

    fake_data = fake_data[:, 0:2, :]
